...
select * from `students`;/*Select all the students*/
select * from `students` where `name` like "H%";/*Select all the students whose names starts with “H”*/
select * from `students` where `name` like  '%a%';/*Select all the students whose name has the alphabet “a”*/
select * from `students` order by `name`;/*Select all the students and list the results sorted in alphabetical order(a-z).*/
...
select * from `marks` where half_yearly is NULL;
...
Format: student_id, subject_id, year
*/
select student_id, subject_id, year from `marks` where annual is NOT NULL or half_yearly is NOT NULL or quarterly is NOT NULL;
...
Format: student_id, subject_id, average, year
*/
select student_id, subject_id, average, year (
select student_id, subject_id, (quarterly+half_yearly+annual)/3 as average, year from `marks` where year in(2004,2005)
) group by subject_id;
select * from `marks`;
